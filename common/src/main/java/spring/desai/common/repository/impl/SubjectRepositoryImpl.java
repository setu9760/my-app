...
public class SubjectRepositoryImpl extends AbstractBaseRepository implements SubjectRepository {
	...
	@Override
	public Collection<Subject> getSubjectsForStudentId(String studentId) throws DataAccessException {
		try {
			List<String> subjIds = getJdbcTemplate().queryForList(getFieldFindBySql(DataBaseConstants.SUBJECT_STUDENT_LINK_TABLE_NAME, DataBaseConstants.STUD_ID, DataBaseConstants.SUBJ_ID), new Object[] { studentId}, String.class);
