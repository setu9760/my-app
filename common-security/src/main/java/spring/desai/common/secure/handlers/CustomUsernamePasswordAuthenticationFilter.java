	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		if ("application/json".equals(request.getHeader("Content-Type"))) {
			try {
				...
				// Fetch username and password parameter from the json string
				// and either create custom request attribute or
				// set them as parameter in existing request before invoking
				// super.attemptAuthenitcation.
				// TODO
				Gson gson = new Gson();
